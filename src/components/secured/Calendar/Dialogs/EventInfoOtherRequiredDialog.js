...
const EventInfoOtherRequiredDialog = ({ open, handleClose, selectedEvent }) => {
  const { handleRequestAccept } = useAddEvents();
    ...
    <ThemeProvider theme={customTheme}>
      <Dialog open={open} onClose={handleClose}>
        ...
        >
          <DialogActions>
            ...
            <Button onClick={handleChangeOpen}>Aceptar solicutd</Button>
          </DialogActions>
        </Box>
      </Dialog>
      <Dialog open={confirmOpen} onClose={handleChangeOpen}>
        ...
        <DialogContent sx={{ maxWidth:400, minHeight: 120, margin:1 }}>
          <DialogContentText>
            Desea aceptar solicitud de cambio de guardia?
          </DialogContentText>
        ...
        <DialogActions>
          ...
          <Button
            onClick={() => {
              handleRequestAccept(selectedEvent.id);
            }}
          >
            Aceptar Solicitud
          </Button>
