...
const EventInfoUserRequiredDialog = ({ open, handleClose, selectedEvent }) => {
  const { handleRequestCancel } = useAddEvents();
    ...
    <ThemeProvider theme={customTheme}>
      <Dialog open={open} onClose={handleClose}>
        ...
        >
          <DialogActions>
            ...
            <Button onClick={handleChangeOpen}>Cancelar Solicitud</Button>
          </DialogActions>
        </Box>
      </Dialog>
      <Dialog open={confirmOpen} onClose={handleChangeOpen}>
        ...
        <DialogContent sx={{ maxWidth:400, minHeight: 120, margin:1 }}>
          <DialogContentText>
            Desea cancelar la solicitud de cambio de guardia?
          </DialogContentText>
        ...
        <DialogActions>
          ...
          <Button
            onClick={() => {
              handleRequestCancel(selectedEvent.id);
            }}
          >
            Cancelar Solicitud
          </Button>
...
export default EventInfoUserRequiredDialog;